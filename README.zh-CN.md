...
<p align="center">
  <strong>正向搭经营模型，逆向拆市场定价，找出真正的预期差。</strong>
</p>
...
`stock-analysis` 希望补上投研最难的中间环节：先核验用户前提和冲突证据，再建立经营模型，并把当前市值逆推出市场已经交易的利润。最终交付不是一句“买入/卖出”，而是你的模型与市场模型之间究竟差在哪里。
...
4. 公司报告先对账正向模型和市值隐含利润，再给核心分歧、反证条件和后续观察指标。
